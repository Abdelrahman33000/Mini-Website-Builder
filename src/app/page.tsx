            ...
            {section.type === 'footer' && (
              <div className="bg-green-100 text-green-800 p-4 rounded space-y-2">
                {section.props.footerItems && section.props.footerItems.length > 0 ? (
                  ...
                  <p className="italic text-gray-600 text-center">[ Footer section is empty ]</p>
                )}
              </div>
            )}
      ...
      <aside className="w-full md:w-1/4 bg-white p-4 border-l border-gray-300 flex flex-col">
        ...
        {!selectedSection ? (
          ...
          <div className="overflow-y-auto max-h-[calc(100vh-6rem)]">
            ...
            <HeroEditor
  props={{
    title: selectedSection.props.title as string,
    subtitle: selectedSection.props.subtitle as string,
    backgroundUrl: selectedSection.props.backgroundUrl as string,
  }}
...
function HeaderEditor({ props, onChange }: HeaderEditorProps) {
  ...
  return (
    <div className="flex flex-col h-full">
      {links.length === 0 && <p className="mb-2 text-gray-500 italic">No links added yet.</p>}
